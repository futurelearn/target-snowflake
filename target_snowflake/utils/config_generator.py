...
if not keyfile_dict['account']:
    raise ValueError("The environment variable SF_ACCOUNT must hold your snowflake account.")
if "snowflakecomputing.com" in keyfile_dict['account'] :
    raise ValueError("SF_ACCOUNT must *ONLY* contain your snowflake account, not the fully qualified domain name!")
